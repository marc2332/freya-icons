...
impl Into<&'static str> for MdCheckBox {
...
impl Into<&'static str> for MdCheckBoxOutlineBlank {
    fn into(self) -> &'static str {
...
impl Into<&'static str> for MdIndeterminateCheckBox {
    fn into(self) -> &'static str {
...
impl Into<&'static str> for MdRadioButtonChecked {
    fn into(self) -> &'static str {
...
impl Into<&'static str> for MdRadioButtonUnchecked {
    fn into(self) -> &'static str {
...
#[derive(Copy, Clone, Debug, PartialEq)]
pub struct MdStar;
impl Into<&'static str> for MdStar {
    fn into(self) -> &'static str {
...
impl Into<&'static str> for MdStarBorder {
    fn into(self) -> &'static str {
...
impl Into<&'static str> for MdStarOutline {
    fn into(self) -> &'static str {
...
impl Into<&'static str> for MdStarPurple500 {
    fn into(self) -> &'static str {
        r#"<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"enable-background="new 0 0 24 24"  viewBox="0 0 24 24" ><g><g><path d="M0,0h24v24H0V0z" fill="none"/></g></g><g><path d="M12,8.89L12.94,12h2.82l-2.27,1.62l0.93,3.01L12,14.79l-2.42,1.84l0.93-3.01L8.24,12h2.82L12,8.89 M12,2l-2.42,8H2 l6.17,4.41L5.83,22L12,17.31L18.18,22l-2.35-7.59L22,10h-7.58L12,2L12,2z"/></g></svg>"#
    }
}
...
impl Into<&'static str> for MdToggleOff {
    fn into(self) -> &'static str {
...
impl Into<&'static str> for MdToggleOn {
    fn into(self) -> &'static str {
